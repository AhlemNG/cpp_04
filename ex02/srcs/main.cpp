...
//     {
//         Tab[i] = new Dog();
//         // std::cout << BLUE << dynamic_cast<Cat*>(const_cast<AAnimal*>(i))->getIdea(0) << RESET << std::endl;
...
// 	dynamic_cast<Cat*>(const_cast<AAnimal*>(i))->setIdea("I hate the dogs!", 0);
//     dynamic_cast<Dog*>(const_cast<AAnimal*>(j))->setIdea("I hate the cats!", 0);
// 	dynamic_cast<Dog*>(const_cast<AAnimal*>(j))->setIdea("I'm hungry!", 1);
	
// 	std::cout << BLUE << dynamic_cast<Cat*>(const_cast<AAnimal*>(i))->getIdea(0) << RESET << std::endl;
//     std::cout << BLUE << dynamic_cast<Dog*>(const_cast<AAnimal*>(j))->getIdea(0) << RESET << std::endl;
// 	std::cout << BLUE << dynamic_cast<Dog*>(const_cast<AAnimal*>(j))->getIdea(1) << RESET << std::endl;
// 	std::cout << "__________________________________________" << std::endl;
//     std::cout << "__________________________________________" << std::endl;

	
// 	std::cout << "___________seg here_______________________________" << std::endl;
//     const AAnimal* k = new Dog(*dynamic_cast<const Dog*>(j));
...
//     std::cout << BLUE << dynamic_cast<Dog*>(const_cast<AAnimal*>(k))->getIdea(0) << RESET << std::endl;
// 	std::cout << BLUE << dynamic_cast<Dog*>(const_cast<AAnimal*>(k))->getIdea(1) << RESET << std::endl;
// 	std::cout << "__________________________________________" << std::endl;
//     std::cout << "__________________________________________" << std::endl;
